...
**HTTP Request**
include::{snippets}/ticket-detail/http-request.adoc[]

**Request Headers**
include::{snippets}/ticket-detail/request-headers.adoc[]

**Path Parameters**
include::{snippets}/ticket-detail/path-parameters.adoc[]

**Query Parameters**
include::{snippets}/ticket-detail/query-parameters.adoc[]

**HTTP Response**
include::{snippets}/ticket-detail/http-response.adoc[]

**Response Fields**
include::{snippets}/ticket-detail/response-fields.adoc[]
...
**HTTP Request**
include::{snippets}/flight-detail/http-request.adoc[]

**Request Headers**
include::{snippets}/flight-detail/request-headers.adoc[]

**Path Parameters**
include::{snippets}/flight-detail/path-parameters.adoc[]

**Query Parameters**
include::{snippets}/flight-detail/query-parameters.adoc[]

**HTTP Response**
include::{snippets}/flight-detail/http-response.adoc[]

**Response Fields**
include::{snippets}/flight-detail/response-fields.adoc[]
