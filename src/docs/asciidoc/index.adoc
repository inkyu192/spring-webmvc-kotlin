...
**HTTP Request**
include::{snippets}/customer-member-create/http-request.adoc[]

**Request Fields**
include::{snippets}/customer-member-create/request-fields.adoc[]

**HTTP Response**
include::{snippets}/customer-member-create/http-response.adoc[]

**Response Fields**
include::{snippets}/customer-member-create/response-fields.adoc[]
...
**HTTP Request**
include::{snippets}/customer-member-get/http-request.adoc[]

**Request Headers**
include::{snippets}/customer-member-get/request-headers.adoc[]

**HTTP Response**
include::{snippets}/customer-member-get/http-response.adoc[]

**Response Fields**
include::{snippets}/customer-member-get/response-fields.adoc[]
...
**HTTP Request**
include::{snippets}/customer-member-update/http-request.adoc[]

**Request Headers**
include::{snippets}/customer-member-update/request-headers.adoc[]

**Request Fields**
include::{snippets}/customer-member-update/request-fields.adoc[]

**HTTP Response**
include::{snippets}/customer-member-update/http-response.adoc[]

**Response Fields**
include::{snippets}/customer-member-update/response-fields.adoc[]
...
**HTTP Request**
include::{snippets}/customer-member-delete/http-request.adoc[]

**Request Headers**
include::{snippets}/customer-member-delete/request-headers.adoc[]

**HTTP Response**
include::{snippets}/customer-member-delete/http-response.adoc[]
...
**HTTP Request**
include::{snippets}/customer-member-password-update/http-request.adoc[]

**Request Headers**
include::{snippets}/customer-member-password-update/request-headers.adoc[]

**Request Fields**
include::{snippets}/customer-member-password-update/request-fields.adoc[]

**HTTP Response**
include::{snippets}/customer-member-password-update/http-response.adoc[]
...
**HTTP Request**
include::{snippets}/partner-member-create/http-request.adoc[]

**Request Fields**
include::{snippets}/partner-member-create/request-fields.adoc[]

**HTTP Response**
include::{snippets}/partner-member-create/http-response.adoc[]

**Response Fields**
include::{snippets}/partner-member-create/response-fields.adoc[]
...
**HTTP Request**
include::{snippets}/partner-member-get/http-request.adoc[]

**Request Headers**
include::{snippets}/partner-member-get/request-headers.adoc[]

**HTTP Response**
include::{snippets}/partner-member-get/http-response.adoc[]

**Response Fields**
include::{snippets}/partner-member-get/response-fields.adoc[]
...
**HTTP Request**
include::{snippets}/partner-member-update/http-request.adoc[]

**Request Headers**
include::{snippets}/partner-member-update/request-headers.adoc[]

**Request Fields**
include::{snippets}/partner-member-update/request-fields.adoc[]

**HTTP Response**
include::{snippets}/partner-member-update/http-response.adoc[]

**Response Fields**
include::{snippets}/partner-member-update/response-fields.adoc[]
...
**HTTP Request**
include::{snippets}/partner-member-delete/http-request.adoc[]

**Request Headers**
include::{snippets}/partner-member-delete/request-headers.adoc[]

**HTTP Response**
include::{snippets}/partner-member-delete/http-response.adoc[]
...
**HTTP Request**
include::{snippets}/partner-member-password-update/http-request.adoc[]

**Request Headers**
include::{snippets}/partner-member-password-update/request-headers.adoc[]

**Request Fields**
include::{snippets}/partner-member-password-update/request-fields.adoc[]

**HTTP Response**
include::{snippets}/partner-member-password-update/http-response.adoc[]
...
**HTTP Request**
include::{snippets}/operator-member-create/http-request.adoc[]

**Request Fields**
include::{snippets}/operator-member-create/request-fields.adoc[]

**HTTP Response**
include::{snippets}/operator-member-create/http-response.adoc[]

**Response Fields**
include::{snippets}/operator-member-create/response-fields.adoc[]
...
**HTTP Request**
include::{snippets}/operator-member-list/http-request.adoc[]

**Request Headers**
include::{snippets}/operator-member-list/request-headers.adoc[]

**Query Parameters**
include::{snippets}/operator-member-list/query-parameters.adoc[]

**HTTP Response**
include::{snippets}/operator-member-list/http-response.adoc[]

**Response Fields**
include::{snippets}/operator-member-list/response-fields.adoc[]
...
**HTTP Request**
include::{snippets}/operator-member-get/http-request.adoc[]

**Request Headers**
include::{snippets}/operator-member-get/request-headers.adoc[]

**Path Parameters**
include::{snippets}/operator-member-get/path-parameters.adoc[]

**HTTP Response**
include::{snippets}/operator-member-get/http-response.adoc[]

**Response Fields**
include::{snippets}/operator-member-get/response-fields.adoc[]
...
**HTTP Request**
include::{snippets}/operator-member-status-update/http-request.adoc[]

**Request Headers**
include::{snippets}/operator-member-status-update/request-headers.adoc[]

**Path Parameters**
include::{snippets}/operator-member-status-update/path-parameters.adoc[]

**Request Fields**
include::{snippets}/operator-member-status-update/request-fields.adoc[]

**HTTP Response**
include::{snippets}/operator-member-status-update/http-response.adoc[]

**Response Fields**
include::{snippets}/operator-member-status-update/response-fields.adoc[]
