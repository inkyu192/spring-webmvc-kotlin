...
**HTTP Request**
include::{snippets}/product-ticket-get/http-request.adoc[]

**Request Headers**
include::{snippets}/product-ticket-get/request-headers.adoc[]

**Path Parameters**
include::{snippets}/product-ticket-get/path-parameters.adoc[]

**Query Parameters**
include::{snippets}/product-ticket-get/query-parameters.adoc[]

==== 티켓 응답

**HTTP Response**
include::{snippets}/product-ticket-get/http-response.adoc[]

**Response Fields**
include::{snippets}/product-ticket-get/response-fields.adoc[]

==== 숙소 응답

**HTTP Response**
include::{snippets}/product-accommodation-get/http-response.adoc[]

**Response Fields**
include::{snippets}/product-accommodation-get/response-fields.adoc[]

==== 항공권 응답

**HTTP Response**
include::{snippets}/product-flight-get/http-response.adoc[]

**Response Fields**
include::{snippets}/product-flight-get/response-fields.adoc[]
