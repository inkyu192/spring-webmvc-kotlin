            ...
            .andDo(
                MockMvcRestDocumentation.document(
                    ...
                    PayloadDocumentation.responseFields(
                        ...
                        PayloadDocumentation.fieldWithPath("content[].phone").description("번호"),
                        PayloadDocumentation.fieldWithPath("content[].gender").description("성별"),
                        PayloadDocumentation.fieldWithPath("content[].birthday").description("생년월일"),
                        PayloadDocumentation.fieldWithPath("content[].createdAt").description("생성일시"),
                        PayloadDocumentation.fieldWithPath("page").description("현재 페이지"),
                        ...
                        PayloadDocumentation.fieldWithPath("hasNext").description("다음 페이지 여부"),
                        PayloadDocumentation.fieldWithPath("hasPrevious").description("이전 페이지 여부"),
                    )
                )
            )
    }
